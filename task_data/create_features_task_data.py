...
if __name__ == '__main__':
    ...
    for vocab_size in config.Task.vocab_sizes:
        ...
        for probe in probes:  # TODO whcih features to use?
            print(probe)
            print(df.loc[(df['Concept'] == probe) & (df['BR_Label'] == 'encyclopaedic')])
        raise SystemExit


        # write to file
        out_path = config.Dirs.tasks / 'semantic_features' / '{}_{}.txt'.format(CORPUS_NAME, vocab_size)
