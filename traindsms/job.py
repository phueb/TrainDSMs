...
from traindsms.architectures import comparator, classifier, aligner, extractor
...
from traindsms.utils import save_corpus_data
from traindsms.utils import move_scores_to_server, save_param2val
...
def main(param2val):
    ...
    for architecture in [
        ...
        for ev in [
            ...
            Identification(architecture, 'nyms', 'syn', suffix='_jwunique'),
            Identification(architecture, 'nyms', 'ant', suffix='_jwunique'),
        ]:
            if ev.suffix != '':
